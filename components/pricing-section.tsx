...
<p className="text-lg text-white/60 max-w-2xl mx-auto mb-8">
  Whether you're a student, developer, or enterprise, QueryMe scales with your needs. Start free and unlock the power of AI-driven database querying.
</p>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {pricingPlans.map((plan, index) => (
            <motion.div
              ...
              whileHover={{ y: -5 }}
              className={`relative rounded-2xl p-8 backdrop-blur-sm border transition-all duration-300 flex flex-col justify-between ${
                plan.popular
